...
[第 34 章：架构模式总结 v2 — 可迁移到你自己项目的设计模式](./34-架构模式总结v2.md)

我们从前 33 章的源码分析中，提炼出可复用的架构模式，并把 v2 新发现的 4 个模式——Bridge IPC、Coordinator-Agent、Migration-as-Code、Output-Style-as-Plugin——并入这张地图。
