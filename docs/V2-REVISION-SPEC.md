...
| C30 | Doctor 屏与 Output Style 体验 | `docs/33-Doctor-屏与-Output-Style-体验.md` | YAO-142 仲裁，YAO-129 落地（NN=33，承接 26/27/28/29/30/31 落地；NN=32 预留给 C29，C29 自己的 issue 启动时由 OC-Dev 登记） |
